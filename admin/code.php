...
elseif(isset($_POST['update_category_btn']))
{
    ...
    $update_query = "UPDATE categories SET name='$name', slug='$slug',description='$description',meta_title='$meta_title',meta_description='$meta_description',meta_keywords='$meta_keywords',
...
elseif(isset($_POST['add_product_btn']))
{
    ...
    if($name !='' && $slug !='' && $description !='')
    {
        ...
        {
            move_uploaded_file($_FILES['image']['tmp_name'], $path.'/'.$filename);
            redirect("add-products.php","Category Added Successfully");
        }
        else
        {
...
elseif(isset($_POST['update_product_btn']))
{
    ...
    description='$description',meta_description='$meta_description',meta_keywords='$meta_keywords',status='$status',trending='$trending',
    ...
    if($update_product_query_run)
    {
        ...
        redirect("edit-product.php?id=$product_id","Producted Updated Successfully");
    }
    else
    {
